    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
      ...
      <div class="flex-1 p-3 sm:p-5 bg-gray-100">
        <section class="video-section p-3 sm:p-4 w-full max-w-5xl mx-auto bg-white shadow-lg rounded-lg">
              <!-- Tombol Kembali ke Layanan di kanan atas konten utama -->
              <div class="flex justify-end pb-2">
                <NuxtLink to="/layanan" class="inline-flex items-center px-4 py-2 bg-white text-blue-700 border border-blue-500 rounded-lg shadow hover:bg-blue-50 transition-colors font-semibold mb-2">
