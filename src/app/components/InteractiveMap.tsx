...
function InteractiveMap() {
  ...
  useEffect(() => {
    const fetchProvinces = async () => {
      try {
        ...
        const combinedData = Array.isArray(provincesData) ? provincesData.map((prov: Province) => ({
          ...prov,
  ...
  const loadKabupaten = async (id_provinsi: number) => {
    try {
      const kabupatenResponse = await fetch(`/api/kabupatens?id_provinsi=${id_provinsi}`);
  ...
  const getChoroplethColor = (jumlah_inovasi: number) => {
    ...
    return '#BDD7E7'; // lightest color for no innovation
  };
  ...
  return (
    <div className="app">
      <div className="flex flex-col items-center">
        <div className="border border-gray-300 p-6 rounded-lg w-full shadow-md">
          <h1 className="font-poppins font-bold text-2xl text-center my-4">
            SEBARAN LABORATORIUM INOVASI
          </h1>
          <div className="w-24 h-2 bg-gradient-to-r from-[#BDD7E7] to-[#08306B] mx-auto mb-5" aria-hidden="true"></div>
        ...
        <div className="legend flex flex-row items-center p-2 rounded bg-gray-100 shadow-md mt-5 w-1/2 justify-center">
          ...
          <div className="legend-item flex items-center mr-2">
            <div className="legend-color" style={{ backgroundColor: '#BDD7E7', width: '20px', height: '20px', borderRadius: '4px', marginRight: '5px' }}></div>
            <span>0</span>
          </div>
          <div className="legend-item flex items-center mr-2">
            <div className="legend-color" style={{ backgroundColor: '#6BAED6', width: '20px', height: '20px', borderRadius: '4px', marginRight: '5px' }}></div>
            <span>1-50</span>
          </div>
          <div className="legend-item flex items-center mr-2">
            <div className="legend-color" style={{ backgroundColor: '#4292C6', width: '20px', height: '20px', borderRadius: '4px', marginRight: '5px' }}></div>
            <span>51-100</span>
          </div>
          <div className="legend-item flex items-center mr-2">
            <div className="legend-color" style={{ backgroundColor: '#2171B5', width: '20px', height: '20px', borderRadius: '4px', marginRight: '5px' }}></div>
            <span>101-150</span>
          </div>
          <div className="legend-item flex items-center mr-2">
            <div className="legend-color" style={{ backgroundColor: '#08519C', width: '20px', height: '20px', borderRadius: '4px', marginRight: '5px' }}></div>
            <span>151-200</span>
          </div>
          <div className="legend-item flex items-center mr-2">
            <div className="legend-color" style={{ backgroundColor: '#08306B', width: '20px', height: '20px', borderRadius: '4px', marginRight: '5px' }}></div>
            <span>200+</span>
          </div>
        </div>
      </div>
